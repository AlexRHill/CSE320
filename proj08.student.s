...
endif9:
		...
		set 	fmt2, %r8 		! First arg -- address of format string
		mov 	%r17, %r9 		! newline count
		
		call 	printf
		nop
		
		set 	fmt3, %r8 		! First arg -- address of format string
		mov 	%r18, %r9 		! whitespace count
		
		call 	printf
		nop
		
		set 	fmt4, %r8 		! First arg -- address of format string
		mov 	%r19, %r9 		! octal count
		
		call 	printf
		nop

		set 	fmt5, %r8 		! First arg -- address of format string
		mov 	%r20, %r9 		! decimal count
		
		call 	printf
		nop

		set 	fmt6, %r8 		! First arg -- address of format string
		mov 	%r21, %r9 		! hexidecimal count
		
		call 	printf
		nop

		set 	fmt7, %r8 		! First arg -- address of format string
		mov 	%r22, %r9 		! letter count
...
fmt2: .asciz "The line contained %d newline characters\n"
fmt3: .asciz "The line contained %d whitespace characters\n"
fmt4: .asciz "The line contained %d octal characters\n"
fmt5: .asciz "The line contained %d decimal characters\n"
fmt6: .asciz "The line contained %d hexidecimal characters\n"
fmt7: .asciz "The line contained %d letters\n"
